...
def conditional_download(download_directory_path: str, urls: List[str], file_name: str=None) -> None:
    ...
    for url in urls:
        ...
        download_file_path = os.path.join(download_directory_path, os.path.basename(file_local))
